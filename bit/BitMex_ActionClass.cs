...
namespace bit.BitMex_ActionClass
{
    public class BitMex_ActionClass
    {
        ...
        public void order_System2(double limit_trad_price , List<bitmex_bucketed> bitemex_Bucketeds, bitemex_position bitemex_position)
        {
            ...
            step1_Qty = 5000; step1_spring = 7.0; _margin1 = 20.0;
            step2_Qty = 5000; step2_spring = 11.0; _margin2 = 20.0;
            step3_Qty = 5000; step3_spring = 15.0; _margin3 = 25.0;
            step4_Qty = 4000; step4_spring = 30.0; _margin4 = 45.0;
            step5_Qty = 4000; step5_spring = 55.0; _margin5 = 60.0;
            step6_Qty = 4000; step6_spring = 80.0; _margin6 = 100.0;
            step7_Qty = 500; step7_spring = 140.0; _margin7 = 160.0;
            step8_Qty = 500; step8_spring = 180.0; _margin8 = 210.0;
            step9_Qty = 500; step9_spring = 250.0; _margin9 = 250.0;
